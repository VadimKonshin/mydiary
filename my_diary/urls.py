...
from my_diary.views import Home, why_diary_view, hello_view, question_view, how_start_view, DiaryListView, \
    DiaryDetailView, DiaryUpdateView, DiaryDeleteView, DiaryCreateView
